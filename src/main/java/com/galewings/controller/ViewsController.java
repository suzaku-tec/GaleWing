...
import com.galewings.dto.input.GetViewSiteListDto;
import com.galewings.dto.input.ViewSaveDto;
import com.galewings.entity.Site;
import com.galewings.entity.View;
import com.galewings.entity.ViewSite;
...
public class ViewsController {
  ...
  public void save(@RequestBody ViewSaveDto viewSaveDto) {
    if (Strings.isNullOrEmpty(viewSaveDto.viewId)) {
      ...
      // View情報を削除
      viewsRepository.deleteViewSite(viewSaveDto.viewId);

      // View情報を追加
      viewSaveDto.siteIdList.forEach(siteUuid -> viewsRepository.insertViewSite(viewSaveDto, siteUuid));
    }
  }

  @PostMapping("/siteList")
  @ResponseBody
  public List<ViewSite> getViewSiteList(@RequestBody GetViewSiteListDto getViewSiteListDto) {
    return viewsRepository.selectViewSiteList(getViewSiteListDto.viewId);
  }
}
